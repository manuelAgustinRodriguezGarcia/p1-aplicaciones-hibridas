...
export function home(peliculas = [], directores = []) {
    let html = ""
    html += "<main>"
    html += "<section class=\"border-b border-slate-800 bg-slate-900\">"
    html += "<div class=\"mx-auto flex max-w-7xl flex-col gap-6 px-4 py-16 lg:flex-row lg:items-center lg:justify-between\">"
    ...
    html += "<p class=\"mt-4 text-slate-400\">Explorá nuestro catálogo de películas por género, año y director.</p>"
    ...
    html += "<a href=\"/directores\" class=\"rounded-lg border border-slate-700 px-4 py-2 text-slate-300 hover:text-amber-400\">Ver directores</a>"
